        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UniversoId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Personagens", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Personagens_Profissoes_ProfissaoId",
                        column: x => x.ProfissaoId,
                        principalTable: "Profissoes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Personagens_Universos_UniversoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Personagens_ProfissaoId",
                table: "Personagens",
                column: "ProfissaoId");

            migrationBuilder.CreateIndex(
                name: "IX_Personagens_UniversoId",
                table: "Personagens",
                column: "UniversoId");
        }
